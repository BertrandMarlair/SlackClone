"use strict";Object.defineProperty(exports,"__esModule",{value:true});exports.subscriptions=exports.USER_DELETED=exports.USER_EDITED=exports.USER_ADDED=exports.mutations=exports.queries=exports.types=void 0;var _User=_interopRequireDefault(require("./resolvers/User"));var _getCurrentUser=_interopRequireDefault(require("./resolvers/getCurrentUser"));var _allUsers=_interopRequireDefault(require("./resolvers/allUsers"));var _registerUser=_interopRequireDefault(require("./resolvers/registerUser"));var _loginUser=_interopRequireDefault(require("./resolvers/loginUser"));var _pubsub=require("../../../utils/pubsub");function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}const types={definitions:`
        type User {
            id: Int!
            username: String!
            email: String!
    ...
    `,resolvers:{User:_User.default}};exports.types=types;const queries={definitions:`
        getCurrentUser: User!
        allUsers: [User!]
    `,resolvers:{getCurrentUser:_getCurrentUser.default,allUsers:_allUsers.default}};exports.queries=queries;const mutations={definitions:`
